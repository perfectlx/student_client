...
import teacherEcharts from '@/views/Teacher/teacherGradeCourseManage/teacherEcharts';
import echartsAllGrade from "@/views/Admin/gradeCourseManage/echartsAllGrade";
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
           ...
           {
            path: '/echartsAllGrade',
            name: '各科成绩平均分',
            component: echartsAllGrade,
            meta: {requireAuth: true}
          }
        ]
      }
