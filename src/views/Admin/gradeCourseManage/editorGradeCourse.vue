  ...
  <div>
    <el-card>
      <el-form style="width: 60%" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('ruleForm')" icon="el-icon-folder-checked">提交</el-button>
          <el-button @click="resetForm('ruleForm')" icon="el-icon-refresh" h >重置</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
