      ...
      <el-main>
        <el-card>
          <el-form :inline="true" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item>
              <el-button type="primary" @click="submitForm('ruleForm')" icon="el-icon-search">查询</el-button>
              <el-button type="info" @click="resetForm('ruleForm')" icon="el-icon-refresh">重置</el-button>
              <el-button type="info" plain @click="flush('ruleForm')" icon="el-icon-loading">刷新</el-button>
            </el-form-item>
          </el-form>
        </el-card>
